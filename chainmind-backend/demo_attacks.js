/**
 * demo_attacks.js
 * Hardcoded synthetic Ethereum transaction feature sets for live testing and demonstration.
 * Contains 2 normal everyday transactions and 4 distinct attack patterns.
 */

const demoAttacks = [
  // 1. Normal Everyday Transfer
  {
  ...
  // 2. Flash Loan Arbitrage Exploit (Attack)
  {
  ...
  // 4. Reentrancy Liquidity Drain Attack (Attack)
  {
  ...
  // 5. High-Frequency Gas Priority Frontrunning Attack (Attack)
  {
  ...
  // 6. Newly Deployed Malicious Contract Exploit (Attack)
  {
